...
def solution(__text: str, __len: int) -> set[str]:
    result = set(word for word in normalize_text(
        __text).split() if len(word) < __len)
    return result


max_len = 4
print(*sorted(solution(sentence, max_len)))
